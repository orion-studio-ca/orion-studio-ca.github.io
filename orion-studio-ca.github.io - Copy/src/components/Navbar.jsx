...
const Navbar = props => {
    ...
    return(
      ...
      <ul className="list-none mx-[2rem] mt-[1rem] p-0 overflow-hidden fixed w-[calc(100vw-4rem)] top-0 rounded-3xl py-2 backdrop-blur-[6px] bg-gradient-to-t from-slate-50/[.05] to-slate-50/[.1] border-white/[.1] border-[1px] shadow-lg">
...
const MenuItem = props => {
    ...
    const styleApplied = `touch-none md:hidden list-none m-0 p-0 overflow-hidden fixed top-[5.5rem] mx-[2rem] bg-opacity-80 rounded-3xl backdrop-blur-[6px] transition-colors bg-gradient-to-t from-slate-50/[.05] to-slate-50/[.1] border-white/[.1] border-[1px] shadow-lg`
