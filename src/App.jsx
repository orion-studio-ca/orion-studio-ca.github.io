  ...
  return (
    <>
      <div className="w-full overflow-hidden">
        <img src="/games/bf.png" className="-z-[1] h-[11rem] top-[8rem] left-[50%] absolute translate-x-[-55%] md:translate-x-[-75%] rounded-3xl border-[1px] border-white/[.1] shadow-lg" />
        <img src="/games/overthrown.png" className="-z-[1] h-[11rem] top-[14rem] left-[50%] absolute translate-x-[-45%] md:translate-x-[-25%] rounded-3xl border-[1px] border-white/[.1] shadow-lg" />
        <h2 className="text-white text-center mt-[28rem] text-5xl">Games made from passion.</h2>
        
        <Platforms />
        <Box title="Games" logo="storeicons/controller.png">
        ...
        <Box title="Publishing Services" logo="storeicons/paint.png">
